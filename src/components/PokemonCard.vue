<template>
  <article
    class="pokemon-slot w-full flex justify-center fixed xl:w-[312px] xl:h-[590px] xl:sticky bottom-[0] xl:bottom-4 xl:border-[2px] border-main border-3 xl:rounded-4"
  >
    <pokeball
      class="pokeball hidden w-[240px] h-[240px] text-main absolute top-[60px] xl:block rotate-[24deg]"
    />
    ...
    >
      ...
      <div class="card-image flex items-center justify-center m:mt-4 m:ml-[8%] xl:m-[0]">
        <pokeball
          :class="[
            'pokeball absolute w-[240px] h-[240px] opacity-50 rotate-[24deg]',
            `text-${mainType}`,
          ]"
        />
        <img
